...
class WeatherBackground extends StatelessWidget {
  ...
  Widget _buildBackground() {
    final colors = BackgroundGradients.forCondition(
      condition,
      _tier,
      isDay: isDay,
    );
    return switch (condition) {
      ...
      WeatherCondition.overcast => OvercastBackground(
        gradientColors: colors,
        isActive: isActive,
      ),
      WeatherCondition.foggy => FogBackground(
        gradientColors: colors,
        isActive: isActive,
      ),
      WeatherCondition.drizzle => DrizzleBackground(
        gradientColors: colors,
        isActive: isActive,
      ),
      WeatherCondition.rain => RainBackground(
        gradientColors: colors,
        isActive: isActive,
      ),
      WeatherCondition.heavyRain => HeavyRainBackground(
        gradientColors: colors,
        isActive: isActive,
      ),
      ...
      WeatherCondition.blizzard => BlizzardBackground(
        gradientColors: colors,
        isActive: isActive,
      ),
      ...
      WeatherCondition.hail => HailBackground(
        gradientColors: colors,
        isActive: isActive,
      ),
