  ...
  Widget build(BuildContext context) {
    return AnimatedBuilder(
      ...
      builder: (context, child) {
        return CustomPaint(
          painter: _OvercastPainter(_time),
          size: Size.infinite,
          child: Container(
...
class _OvercastPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    _drawCloud(canvas, size.width * 0.15 + sin(time * 0.35) * 20,
        size.height * 0.08, 90, 0.14);
    _drawCloud(canvas, size.width * 0.6 + sin(time * 0.3 + 1) * 25,
        size.height * 0.12, 100, 0.16);
    _drawCloud(canvas, size.width * 0.35 + sin(time * 0.4 + 2) * 18,
        size.height * 0.28, 95, 0.15);
    _drawCloud(canvas, size.width * 0.8 + sin(time * 0.28 + 3) * 30,
        size.height * 0.38, 80, 0.12);
    _drawCloud(canvas, size.width * 0.1 + sin(time * 0.45 + 4) * 22,
        size.height * 0.52, 85, 0.13);
    _drawCloud(canvas, size.width * 0.55 + sin(time * 0.32 + 5) * 20,
        size.height * 0.65, 90, 0.11);
    _drawCloud(canvas, size.width * 0.3 + sin(time * 0.38 + 6) * 24,
        size.height * 0.78, 75, 0.1);
    _drawCloud(canvas, size.width * 0.75 + sin(time * 0.42 + 7) * 18,
        size.height * 0.88, 85, 0.12);
  }
